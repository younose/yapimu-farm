	...
	var paidinvoices = function(){
		var options = {
		  series: [
			{
				name: 'Net Profit',
				data: [100,300, 100, 400, 200, 400,300, 200, 400,100,300, 100,200, 400, 200, 400],
				/* radius: 30,	 */
			}, 				
		],
			chart: {
	...
	var unpaidinvoices = function(){
		var options = {
		  series: [
			{
				name: 'Net Profit',
				data: [100,300, 100, 400,300,200, 400,100,300, 100,200, 400, 200, 200, 400],
				/* radius: 30,	 */
			}, 				
		],
			chart: {
	...
	var totalinvoicessent = function(){
		var options = {
		  series: [
			{
				name: 'Net Profit',
				data: [100,300, 100, 400,300,200, 400,100,300, 100,200, 400, 200, 100, 400],
				/* radius: 30,	 */
			}, 				
		],
			chart: {
